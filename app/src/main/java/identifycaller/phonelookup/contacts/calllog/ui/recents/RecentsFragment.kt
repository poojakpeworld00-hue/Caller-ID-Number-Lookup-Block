...
import identifycaller.phonelookup.contacts.calllog.databinding.FragmentRecentsBinding
...
class RecentsFragment : BaseFragment<FragmentRecentsBinding>() {
    ...
    private fun openDetail(entry: identifycaller.phonelookup.contacts.calllog.data.CallEntry) {
