package identifycaller.phonelookup.contacts.calllog.ui.terms
...
import identifycaller.phonelookup.contacts.calllog.databinding.ActivityTermsBinding
...
class TermsActivity : BaseActivity<ActivityTermsBinding>() {
    ...
    override fun initView() {
        ...
        IntroDisplayPolicy.markShown(this, IntroDisplayConfig.TERMS)
        ...
        // enabled so back never falls through to BaseActivity's exit handler;
    ...
    private fun openOverlayPermission() {
        ...
        // drop OverlayPermissionActivity on top here: launching our own activity
    ...
    private fun proceedToNextScreen() {
        ...
        // Onboarding follows the same IntroDisplayPolicy frequency gate as Splash.
        val next = if (IntroDisplayPolicy.shouldShowOnboarding(this)) OnboardingActivity::class.java
