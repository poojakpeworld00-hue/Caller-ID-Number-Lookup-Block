package identifycaller.phonelookup.contacts.calllog.ui.splash
...
import identifycaller.phonelookup.contacts.ap_ad_module.presentation.showAppRedirectPopup
...
import identifycaller.phonelookup.contacts.calllog.databinding.ActivitySplashBinding
...
import identifycaller.phonelookup.contacts.calllog.ui.onboarding.OnboardingActivity
import identifycaller.phonelookup.contacts.calllog.ui.terms.TermsActivity
...
class SplashActivity : BaseActivity<ActivitySplashBinding>() {
    ...
    private companion object {
        // Shared with ADHomeActivity's tracing. Filter: `adb logcat -s SplashFlow`
    ...
    override fun initView() {
        ...
        getData(this, true, object : OnGetData {
...
//        }, WATCHDOG_TIMEOUT_MS)
    ...
    private fun proceedNow() {
        ...
        val redirectLink = AdsPreferance.getInstance(this).getString("In_App_Update_Link")
    ...
    private fun launchNext() {
        ...
        // AppOpenAdManager (via CallerPhoneLookApp.handleAppForeground) and,
     ...
     *
     * Language, Terms and Onboarding are all gated by [IntroDisplayPolicy] (the
    ...
    private fun nextScreen(): Class<*> = when {
        IntroDisplayPolicy.shouldShowLanguage(this) -> LanguageActivity::class.java
    ...
    private fun route() {
        val next = when {
            !prefs.isLanguageSelected -> LanguageActivity::class.java
            !prefs.isTermsAccepted -> TermsActivity::class.java
