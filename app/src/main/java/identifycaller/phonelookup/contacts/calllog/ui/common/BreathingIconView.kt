 ...
 */
class BreathingIconView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.BreathingIconView)
        val iconRes = a.getResourceId(R.styleable.BreathingIconView_biv_icon, 0)
        val discRes = a.getResourceId(
            R.styleable.BreathingIconView_biv_disc, R.drawable.bg_empty_circle_tools
        )
        val ringRes = a.getResourceId(
            R.styleable.BreathingIconView_biv_ring, R.drawable.bg_ring_tools
        )
        val iconSize = a.getDimensionPixelSize(R.styleable.BreathingIconView_biv_iconSize, 0)
        val hasTint = a.hasValue(R.styleable.BreathingIconView_biv_iconTint)
        val tint = a.getColor(R.styleable.BreathingIconView_biv_iconTint, 0)
        a.recycle()
