...
import identifycaller.phonelookup.contacts.calllog.databinding.ActivitySoundMeterBinding
import java.io.File
...
class SoundMeterActivity : BaseActivity<ActivitySoundMeterBinding>() {
