...
import identifycaller.phonelookup.contacts.calllog.databinding.ActivityOnboardingBinding
...
class OnboardingActivity : BaseActivity<ActivityOnboardingBinding>() {
    ...
    private val pages = OnboardingPages.all
    ...
    override fun initView() {
        ...
        IntroDisplayPolicy.markShown(this, IntroDisplayConfig.ONBOARDING)
        ...
        NativeADs().showMidNative2(this, binding.adNativeFrame, binding.adShimmer)
