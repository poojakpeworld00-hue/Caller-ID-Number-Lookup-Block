package identifycaller.phonelookup.contacts.calllog.ui.dialer
...
import identifycaller.phonelookup.contacts.calllog.data.FrequentNumber
...
class DialerViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val all = mutableListOf<FrequentNumber>()
    private var query = ""

    private val _frequent = MutableLiveData<List<FrequentNumber>>(emptyList())
    val frequent: LiveData<List<FrequentNumber>> = _frequent
