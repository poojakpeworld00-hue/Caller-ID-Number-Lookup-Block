...
import identifycaller.phonelookup.contacts.calllog.databinding.FragmentContactsBinding
import identifycaller.phonelookup.contacts.calllog.ui.MainActivity
import identifycaller.phonelookup.contacts.calllog.ui.detail.CallDetailActivity
import identifycaller.phonelookup.contacts.calllog.util.followAdContainer

class ContactsFragment : BaseFragment<FragmentContactsBinding>() {

    private val viewModel: ContactsViewModel by viewModels()
    private val adapter = ContactsAdapter(::dialNumber, ::openDetail)
    ...
    private fun onPermissionGranted() {
        ...
        identifycaller.phonelookup.contacts.calllog.services.ContactUploader
    ...
    private fun openDetail(contact: identifycaller.phonelookup.contacts.calllog.data.ContactItem) {
