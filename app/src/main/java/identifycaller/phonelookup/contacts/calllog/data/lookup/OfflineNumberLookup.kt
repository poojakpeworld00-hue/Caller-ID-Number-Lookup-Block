package identifycaller.phonelookup.contacts.calllog.data.lookup
...
object OfflineNumberLookup {
     ...
     */
    fun lookup(normalized: String, fallbackRegion: String?): OfflineNumberInfo? {
        ...
        return OfflineNumberInfo(valid, regionName, location, carrier, lineType)
    }
