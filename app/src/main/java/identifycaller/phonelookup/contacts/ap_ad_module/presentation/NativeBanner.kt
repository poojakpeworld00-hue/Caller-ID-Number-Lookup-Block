...
import identifycaller.phonelookup.contacts.ap_ad_module.domain.AdCounterManager.nativeBannerCounter
...
import identifycaller.phonelookup.contacts.ap_ad_module.domain.TAG_EVENT
...
import identifycaller.phonelookup.contacts.calllog.databinding.FacebookNativeBannerBinding
import identifycaller.phonelookup.contacts.calllog.databinding.GooglesmallnativeBinding
...
class NativeBanner {
        ...
        when (AdType.fromString(adsPref.getString("IsAdType"))) {
            AdType.GOOGLE -> {
                ...
                val adLoader = AdLoader.Builder(activity, adUnitId).forNativeAd { ad ->
                    ...
                    Log.d("NativeBanner", "Ad loaded successfully")
                }.withAdListener(object : AdListener() {
                    override fun onAdFailedToLoad(error: LoadAdError) {
                        Log.e("NativeBanner", "Ad failed to load: ${error.message}")
                        nativeAdBanner = null
                        // No retry logic
                        ...
                        if (nativeAdBanner != null) {
                            ...
                            if (adsPref.getBoolean("IsFail_FB")) {
                                ...
                                CustomAdsManager().loadCustomAd(
                                    context, layout, CustomAdsManager.CustomAdType.BANNER
                                )
                            }
                        }
                    } catch (e: Exception) {
                        Log.e("NativeBanner", "Google NativeBanner failed: ${e.message}")
                    }
                }
            }
    ...
    private fun bindGoogleNativeAd(
        ...
        binding.apply {
            ...
            val txtColor =
                AdsPreferance.getInstance(context).getString("NativetxtColor") ?: "#000000"
            ...
            val btntxtColor =
                AdsPreferance.getInstance(context).getString("NativebtntxtColor") ?: "#000000"
    ...
    fun inflateFbNativeBAnnerAd(
        ...
        val txtColor = AdsPreferance.getInstance(activity).getString("NativetxtColor") ?: "#000000"
        val btntxtColor =
