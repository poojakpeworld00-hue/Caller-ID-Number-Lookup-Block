...
class AdsPreferance constructor(context: Context) {
    ...
    companion object {
        ...
        @Volatile
        private var instance: AdsPreferance? = null

        fun getInstance(context: Context): AdsPreferance {
            return instance ?: synchronized(this) {
                instance ?: AdsPreferance(context.applicationContext).also {
                    instance = it
                }
            }
        }
         ...
         */
        fun getOrNull(): AdsPreferance? = instance
    }
