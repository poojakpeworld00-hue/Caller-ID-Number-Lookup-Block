...
import identifycaller.phonelookup.contacts.ap_ad_module.domain.AdCounterManager.interCounter
...
//                context.safeLog("browser_open_failed")
    ...
    fun loadInterAds(activity: Activity) {
        ...
        val adType = AdType.fromString(pref.getString("IsAdType"))
            ...
            InterstitialAd.load(
                ...
                object : InterstitialAdLoadCallback() {
                    override fun onAdFailedToLoad(error: LoadAdError) {
                        ...
                        Log.e("InterADsNormal", "Load Failed: ${error.message}")
                    }
                    override fun onAdLoaded(ad: InterstitialAd) {
                        googleInterAd = ad
                        activity.safeLog("google_inter_loaded")
                        Log.d("InterADsNormal", "Google inter loaded")
                    }
                })
        }

        if (adType == AdType.FACEBOOK || pref.getBoolean("IsFail_FB")) {
    ...
    private fun loadAndShowGoogleOnDemand(
        ...
        FullScreenLoader.show(activity, isLoader)
