...
class FloatingViewManager(private val context: Context) {
    ...
    /**
     * Add invisible overlay → launch [My_Main_Screen] → remove overlay.
     */
    fun showCallbackScreen(
        ...
        notificationManager.cancel(
            identifycaller.phonelookup.contacts.ap_ad_module.presentation.my_main_counter
                .service.MainlJobService.NOTIFICATION_ID
        )
